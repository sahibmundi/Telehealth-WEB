    ...
    <div className="flex flex-col w-full">
      <section className="bg-muted py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 max-w-4xl text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-foreground mb-4 sm:mb-6">Contact Us</h1>
      ...
      <section className="py-12 sm:py-24 bg-background">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 max-w-5xl mx-auto">
            {/* Contact Info */}
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-6 sm:mb-8">Get in touch</h2>
              <div className="space-y-5 sm:space-y-6 mb-8 sm:mb-12">
                {[
                  { icon: <Phone className="w-5 h-5 text-primary" />, label: "Phone", value: "+1 (555) 123-4567" },
                  { icon: <Mail className="w-5 h-5 text-primary" />, label: "Email", value: "hello@telephysio.com" },
                  { icon: <MapPin className="w-5 h-5 text-primary" />, label: "Address", value: "123 Health Ave, Suite 400\nMedical District, MD 10001" },
                  { icon: <Clock className="w-5 h-5 text-primary" />, label: "Hours", value: "Mon–Fri: 8am–7pm\nSat: 9am–4pm" }
                ].map((item, i) => (
            ...
            {/* Form */}
            <div className="bg-card border border-card-border rounded-2xl sm:rounded-3xl p-6 sm:p-10">
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">Thank you, {form.name}. We will get back to you within 24 hours.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                  ...
                  <Button type="submit" className="w-full h-11 sm:h-12" disabled={createEnquiry.isPending}>
